...
import com.erp.workflow.support.MdmDomainTypeSupport;
import com.erp.workflow.support.MdmWorkflowBusinessSupport;
...
public class WorkflowBindingResolverImpl implements IWorkflowBindingResolver {
    ...
    private void createEmployeeDefaultDefinition(String processKey) {
        ...
        definition.setRemark("工作流按需补齐员工审批流程定义");
    ...
    private String resolveEmployeeFormSchema(String processKey) {
        ...
        return "{\"version\":1,\"fields\":["
                + "{\"fieldCode\":\"empCode\",\"fieldLabel\":\"员工编码\",\"componentType\":\"input\",\"required\":true,\"placeholder\":\"工作流自动带出\",\"options\":[]},"
